...
GLEmissive::GLEmissive(const char* name) : GLNode(name)
{
    ...
    BaseLight bspt0 = {glm::vec4(1.0f, 1.0f, 1.0f, 0.0f),
                     0.8f,
                     0.8f};
    PointLight spt0 = {glm::vec4(10.0f, 10.0f, 1.0f, 1.0f),
                      bspt0};
    SpotLight sp0 = {glm::vec4(-1.0, -1.0f, 0.0f, 1.0f),
                      spt0};
    this->lights.spot[0] = sp0;

    BaseLight bspt1 = {glm::vec4(1.0f, 1.0f, 1.0f, 0.0f),
                     0.8f,
                     0.8f};
    PointLight spt1 = {glm::vec4(0.0f, 15.0f, 0.0f, 1.0f),
                      bspt1};
    SpotLight sp1 = {glm::vec4(0.0f, -1.0f, -1.0f, 1.0f),
                      spt1};
    this->lights.spot[1] = sp1;

    BaseLight bspt2 = {glm::vec4(1.0f, 1.0f, 1.0f, 0.0f),
                     0.8f,
                     0.8f};
    PointLight spt2 = {glm::vec4(0.0f, 15.0f, 0.0f, 1.0f),
                      bspt2};
    ...
    BaseLight bspt3 = {glm::vec4(1.0f, 1.0f, 1.0f, 1.0f),
                     0.8f,
                     0.8f};
    PointLight spt3 = {glm::vec4(15.0f, 15.0f, 0.0f, 1.0f),
                      bspt3};
    ...
    BaseLight bspt4 = {glm::vec4(1.0f, 1.0f, 1.0f, 1.0f),
                     0.8f,
                     0.8f};
    PointLight spt4 = {glm::vec4(2.0f, 5.0f, -5.0f, 1.0f),
                      bspt4};
    ...
    BaseLight bspt5 = {glm::vec4(1.0f, 1.0f, 1.0f, 1.0f),
                     0.8f,
                     0.8f};
    PointLight spt5 = {glm::vec4(-3.0f, -3.0f, 7.0f, 1.0f),
                      bspt5};
